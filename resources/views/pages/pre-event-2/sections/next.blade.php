<section class="px-6 py-10 sm:px-10 lg:px-20 next-section">
    ...
    >
        ...
        {{-- Background Number --}}
        <span
            class="absolute right-0 top-1/2 -translate-y-1/2 text-[200px] font-semibold leading-none text-white/70 next-number"
        >
            MAIN
        </span>
        ...
        <div class="relative z-10 max-w-[640px]">
            ...
            >
                The 2nd phase is complete. See how the catalyst journey continues in Main Event
            </p>
