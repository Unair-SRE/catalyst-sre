...
<nav class="flex h-full min-h-0 flex-col" aria-label="Participant dashboard">
    ...
    <div class="flex flex-1 flex-col gap-6 px-3 pb-5 {{ $showBrand ? '' : 'pt-3' }}">
        <div class="border-catalyst-grey/30 border-b pb-4">
            <p class="px-2 text-xs font-medium uppercase tracking-widest text-catalyst-muted">Overview</p>
            <ul class="mt-2">
                <li>
                    <a class="flex items-center gap-3 rounded-md px-2 py-2 text-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-catalyst-primary {{ $active === 'overview' ? 'font-semibold text-catalyst-ink' : 'font-medium text-catalyst-muted' }}" href="{{ route('dashboard.index') }}" @if ($active === 'overview') aria-current="page" @endif>
        ...
        <div>
            <p class="px-2 text-xs font-medium uppercase tracking-widest text-catalyst-muted">Others</p>
            <ul class="mt-2">
                <li>
                    <a class="flex items-center gap-3 rounded-md px-2 py-2 text-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-catalyst-primary {{ $active === 'profile' ? 'font-semibold text-catalyst-ink' : 'font-medium text-catalyst-muted' }}" href="{{ route('dashboard.profile.index') }}" @if ($active === 'profile') aria-current="page" @endif>
                        <svg class="size-4" viewBox="0 0 20 20" fill="none" aria-hidden="true">
